...
export const uz: Copy = {
  ...
  about: {
    ...
    note: {
      ...
      consent: 'Rozilik',
      middle:
        ' asosida qayta ishlanadi. Uni istalgan vaqtda qaytarib olish mumkin — botda yoki ',
      after: ' manziliga xat yozib.',
    },
  },
  footer: {
    ...
    telegramBot: 'Telegramdagi bot',
    telegramChannel: 'Telegramdagi kanal',
    telegramChat: 'Telegramdagi chat',
    maxBot: 'MAXdagi bot',
    maxChannel: 'MAXdagi kanal',
